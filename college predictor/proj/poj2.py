...
# Train RandomForest models for CET and JEE datasets (you need to replace this with your training code)
model_cet = RandomForestClassifier()
model_cet.fit(data_cet[['percentile']], data_cet['college_label'])

model_jee = RandomForestClassifier()
model_jee.fit(data_jee[['rank']], data_jee['college_label'])
...
if __name__ == '__main__':
    ...
    # Run Flask app
    app.run(port=5500)  # Replace with the port your server is running on
